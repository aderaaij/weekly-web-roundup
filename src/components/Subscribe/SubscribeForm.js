...
const actionURL =
    'https://cfye.us2.list-manage.com/subscribe/post?u=9017bc446315b0e178f438760&amp;id=b98c426677';
                    ...
                    >
                        <div id="mc_embed_signup_scroll">
                            <label htmlFor="mce-EMAIL">
                                Subscribe to the mailing list to get the weekly
                                roundup in your inbox!
                            </label>
                            <div className={inputButtonWrap}>
                                ...
                                >
                                    <input
                                        type="text"
                                        name="b_9017bc446315b0e178f438760_b98c426677"
                                        tabIndex="-1"
                                        value=""
                                    />
                                </div>
